               ...
               int *n_p)
{
   ...
   MPI_Unpack(&pack_buf, 100, &position_out, a_p, 1, MPI_DOUBLE, MPI_COMM_WORLD);
   MPI_Unpack(&pack_buf, 100, &position_out, b_p, 1, MPI_DOUBLE, MPI_COMM_WORLD);
   MPI_Unpack(&pack_buf, 100, &position_out, n_p, 1, MPI_INT, MPI_COMM_WORLD);
